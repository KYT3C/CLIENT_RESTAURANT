 ...
 * {@link MenuDrinkFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MenuDrinkFragment#newInstance} factory method to
...
public class MenuDrinkFragment extends Fragment {
    ...
    List<Drink> dishList = new ArrayList<>();
    TextView name, price, stock, description;
    EditText editTextName, editTextPrice, editTextStock, editTextDescription;
    ...
    public static MenuDrinkFragment newInstance(String param1, String param2) {
        MenuDrinkFragment fragment = new MenuDrinkFragment();
    ...
    MenuDrinkAdapter recyclerViewAdapterDrink;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewDrink = v.findViewById(R.id.recyclerview_menu_starter_id);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View customLayout = mInflater2.inflate(R.layout.drink_add_layout, null);
    ...
    public class GetDishAsyncTask extends AsyncTask<String, Void, String> {
        ...
        PublicKey publicKey;
        List<Drink> dishList2 = new ArrayList<Drink>();
        int option;
        ...
        protected void onPostExecute(String s) {
            ...
            dishList = dishList2;
            recyclerViewAdapterDrink = new MenuDrinkAdapter(getContext(), dishList);
            recyclerViewDrink.setLayoutManager(new GridLayoutManager(getContext(), 3));
            recyclerViewDrink.setAdapter(recyclerViewAdapterDrink);
            ...
            try {
                ...
                if (option == 1) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        dishList2.add(new Drink(dishName, idItemDish, price, quantityStock, statusDish, descriptionDish));
